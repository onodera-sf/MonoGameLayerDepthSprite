...
namespace LayerDepthSprite
{
    ...
    protected override void Draw(GameTime gameTime)
    {
      ...
      // 最背面に描画(赤)
      _spriteBatch.Draw(_texture, new Vector2(150.0f, 50.0f), null,
          Color.Red, 0.0f, Vector2.Zero, 1.0f, SpriteEffects.None, 1.0f);

      // 最前面に描画(緑)
      _spriteBatch.Draw(_texture, new Vector2(110.0f, 90.0f), null,
          Color.Green, 0.0f, Vector2.Zero, 1.0f, SpriteEffects.None, 0.0f);

      // ２つのスプライトの間に描画(青)
      _spriteBatch.Draw(_texture, new Vector2(190.0f, 130.0f), null,
